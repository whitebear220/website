...
#MURANO_API_URL = 'http://Controller:8082'
...
# will be looked up as keys 3in the dictionary. If a match is found,
...
#  -manage db_load_metadefs <directory_with_definition_files>
#
